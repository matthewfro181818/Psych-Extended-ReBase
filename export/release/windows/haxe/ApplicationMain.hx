...
class ApplicationMain
{
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "162";
		app.meta["company"] = "KralOyuncu";
		app.meta["file"] = "PsychEngine";
		app.meta["name"] = "FNF': Psych Extended Debug";
		app.meta["packageName"] = "com.kraloyuncu.psychextendedrebasedebug";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "FNF': Psych Extended Debug",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "FNF': Psych Extended Debug";
		#else
